...
url= 'https://terms.naver.com/entry.naver?docId=2075886&categoryId=42918&cid=42918#TABLE_OF_CONTENT6'
...
for section in sections:
    ...
    if section == 1:
        start_range, end_range = 4, 6
    elif section == 2:
        start_range, end_range = 8, 14
    elif section == 3:
        start_range, end_range = 16, 18
    elif section == 4:
        start_range, end_range = 19, 30
    elif section == 12:
        start_range, end_range = 55, 58

    
    if section != 4 and section != 12:
...
collectionName = 'lightning'  # 컬렉션 이름
