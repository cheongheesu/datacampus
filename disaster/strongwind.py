...
url= 'https://terms.naver.com/entry.naver?docId=2075861&categoryId=42918&cid=42918'
...
for section in sections:
    ...
    if section == 1:
        ...
        start_range, end_range = 7, 9
    elif section == 6:
        start_range, end_range = 16, 19
...
collectionName = 'strongwind'  # 컬렉션 이름
